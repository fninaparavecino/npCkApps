/*******************
 * npCase2: Selective Matrix Addition without nested parallelism. 
...
#include <sys/time.h>
using namespace std;
__global__ void selectiveMatrixAdd(int* A, int *B, int *C, int rows, int cols)
{
...
int main(int argC, char** argV)
{
	...
	selectiveMatrixAdd<<<blocks,threads>>>(devA, devB, devC2, ROWS, COLS);
